  ...
  <div class="dashboard">
    <el-row :gutter="40">
      <el-col>
        <el-card>
          <el-col :span="18">
            <ve-line :data="chartData" :loading="loading" :settings="chartSettings" :title="{
                text: '网络性能状况'
          ...
          <el-col :span="6">
            <div class="server-status-list">
              <h3>服务器使用状况</h3>
              <div class="server-status-item" v-for="item in serverData" :key="item.name">
                <p class="server-status-item-title">{{ item.name }}</p>
                <el-progress :text-inside="true" :stroke-width="16" :percentage="item.value" :color="item.color">
                </el-progress>
              </div>
            </div>
          </el-col>
          ...
          <el-row :gutter="40">
            <el-col :span="6">
              <div class="chart-item-warpper">
                <ve-line height="200px" :extend="visitsChartExtend" :data="visitsChartData" :settings="chartSettings"
            ...
            <el-col :span="6">
              <div class="chart-item-warpper">
                <ve-histogram height="200px" :extend="pageviewChartExtend" :data="visitsChartData"
                  :settings="chartSettings" :loading="loading"></ve-histogram>
              </div>
              <p class="chart-item-value text-c">
            ...
            <el-col :span="6">
              <div class="chart-item-warpper">
                <ve-line height="200px" :extend="returingChartExtend" :data="returningChartData"
                  :settings="chartSettings" :loading="loading"></ve-line>
              </div>
              <p class="chart-item-value text-c">
            ...
            <el-col :span="6">
              <div class="chart-item-warpper">
                <ve-line height="200px" :extend="pageVisitsChartExtend" :data="pageVisitsChartData"
                  :settings="chartSettings" :loading="loading"></ve-line>
              </div>
              <p class="chart-item-value text-c">
                <cc-count-to style="font-size: 22px" :usegroup="true" :start="0" :end="55543">
      ...
      <el-col :span="12">
        <el-collapse-transition>
          <div v-show="showUnique">
            <el-card v-loading="loadingUnique">
              <div slot="header" class="clearfix">
                <div class="card-title-box">
                  <span class="card-title">Mobile Visit</span>
                  <div>
                    <cc-svg-icon class="icon-action-item" icon-class="refresh" @click="refreshLoadUniqueData">
                    </cc-svg-icon>
              ...
              <el-row :gutter="20">
                <el-col :span="6">
                  <div class="unique-item" style="flex-direction: column;">
                    <cc-count-to style="font-size: 22px;font-weight: 700;color: #666;" :usegroup="true" :start="0"
                ...
                <el-col :span="9">
                  <div class="unique-item">
                    <div class="unique unique-progress">
                      <el-progress type="circle" :percentage="uniqueData.iphone" :stroke-width="12" color="#0aade7">
                      </el-progress>
                    </div>
                ...
                <el-col :span="9">
                  <div class="unique-item">
                    <div class="unique unique-progress">
                      <el-progress type="circle" :percentage="uniqueData.android" :stroke-width="12" color="#a979d2">
                      </el-progress>
                    </div>
                    <div class="unique unique-icon">
      ...
      <el-col :span="12">
        <el-collapse-transition>
          <div v-show="showUniquePc">
            <el-card v-loading="loadingUniquePc">
              <div slot="header" class="clearfix">
                <div class="card-title-box">
                  <span class="card-title">PC Visit</span>
                  <div>
                    <cc-svg-icon class="icon-action-item" icon-class="refresh" @click="refreshLoadUniquePcData">
                    </cc-svg-icon>
                    <cc-svg-icon class="icon-action-item" icon-class="close" @click="showUniquePc = false">
                    </cc-svg-icon>
                  </div>
                </div>
              </div>
              ...
              <el-row :gutter="20">
                ...
                <el-col :span="9">
                  <div class="unique-item">
                    <div class="unique unique-progress">
                      <el-progress type="circle" :percentage="uniqueData.windows" :stroke-width="12" color="#0067a6">
                      </el-progress>
                    </div>
                    <div class="unique unique-icon">
                ...
                <el-col :span="9">
                  <div class="unique-item">
                    <div class="unique unique-progress">
                      <el-progress type="circle" :percentage="uniqueData.mac" :stroke-width="12" color="#c4b4e4">
                      </el-progress>
                    </div>
                    <div class="unique unique-icon">
