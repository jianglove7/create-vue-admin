        ...
        <el-card>
          <el-row :gutter="40">
            ...
            <el-col :span="6">
              ...
              <p class="chart-item-value text-c">
                <base-count-up style="font-size: 22px" :start="0" :end="25">
            ...
            >
              <div slot="header" class="clearfix">
                <div class="card-title-box">
                  ...
                  <div>
                    <base-icon class="icon-action-item" icon-class="refresh" @click="refreshLoadUniqueData"></base-icon>
                    <base-icon class="icon-action-item" icon-class="close" @click="showUnique = false"></base-icon>
                  </div>
                </div>
              </div>
              ...
              <el-row :gutter="20">
                ...
                <el-col :span="9">
                  <div class="unique-item">
                    ...
                    <div class="unique unique-icon">
                      <base-icon icon-class="iphone" class="unique-icon" style="color: #0aade7;"></base-icon>
                    </div>
                ...
                <el-col :span="9">
                  <div class="unique-item">
                    ...
                    <div class="unique unique-icon">
                      <base-icon icon-class="android" class="unique-icon" style="color: #a979d2;"></base-icon>
                    </div>
                    <div class="unique unique-desc">
                      <span>Android</span>
                    </div>
            ...
            >
              <div slot="header" class="clearfix">
                <div class="card-title-box">
                  ...
                  <div>
                    <base-icon class="icon-action-item" icon-class="refresh" @click="refreshLoadUniquePcData"></base-icon>
                    <base-icon class="icon-action-item" icon-class="close" @click="showUniquePc = false"></base-icon>
                  </div>
                </div>
              </div>
              ...
              <el-row :gutter="20">
                ...
                <el-col :span="9">
                  <div class="unique-item">
                    ...
                    <div class="unique unique-icon">
                      <base-icon icon-class="windows" class="unique-icon" style="color: #0067a6;"></base-icon>
                    </div>
                    <div class="unique unique-desc">
                      <span>Windows</span>
                    </div>
                ...
                <el-col :span="9">
                  <div class="unique-item">
                    ...
                    <div class="unique unique-icon">
                      <base-icon icon-class="mac" class="unique-icon" style="color: #c4b4e4;"></base-icon>
                    </div>
                    <div class="unique unique-desc">
                      <span>Mac</span>
                    </div>
...
export default {
  ...
  methods: {
    async loadServerData () {
      const res = await this.$api.dashboard.loadServerStatus();
      this.serverData = res.serverData;
    },
    async loadNetworkData () {
      const res = await this.$api.dashboard.loadNetworkPerformanceStatus();
    ...
    async loadPvData () {
      ...
      const response = await this.$api.dashboard.loadPvStatus();
    ...
    async loadUniqueData () {
      const res = await this.$api.dashboard.loadVisitStatus();
      // await delay(this.delayTime)
      this.uniqueData = res;
    }
  }
